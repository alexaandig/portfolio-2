...
class NavBar extends HTMLElement {
    ...
    template.innerHTML = `
     ...
     <div class="dsnload p-absolute"> 
         <span class="dsnload__row"> 
             ...
             <img src="assets/img/logo-light.png" class="logo-dark" alt="Alexa" decoding="async" loading="lazy"/> 
             <img src="assets/img/logo.png" class="logo-light" alt="Alexa" decoding="async" loading="lazy"/> 
             </span> 
         </span> 
 ...
 <main id="main_root" class="main-root"> 
     ...
     <header id="site_menu_header" class="site-header  dsn-container d-none dsn-hamburger"> 
         <div class="main-logo"> 
             <a href="index-2.html" data-dsn-text="Alexa" class="custom-logo-link main-brand effect-ajax" rel="home" 
                aria-current="page"> 
                 <img src="assets/img/logo-light.png" class="custom-logo logo-light" alt="Alexa"/> 
                 <img src="assets/img/logo.png" class="custom-logo logo-dark" alt="Alexa"/> 
             </a> 
         </div> 
             ...
             <div class="container-content  d-flex flex-column justify-content-center section-margin"> 
                 <div class="nav__info"> 
                     ...
                     <div class="nav-content mt-30"> 
                         ...
                         <p class="links over-hidden"><a class="link-hover" href="mailto:contact@alexaandig.ml" 
                                                         data-hover-text="contact@alexaandig.ml">contact@alexaandig.ml</a></p> 
